      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          ...
          <ul class="nav navbar-nav navbar-right">
            <li><a href="" style="font-size: 18px; text-transform:capitalize;"><?php echo $_SESSION['admin_name']; ?></a></li>
            ...
            <div class="panel panel-default">
              ...
              <div class="panel panel-default">
                ...
                <div class="panel-body">
                  ...
                  <?php $latest_user = mysqli_query($con, "SELECT * FROM users ORDER BY id DESC LIMIT 5"); while($latest_user1 = mysqli_fetch_array($latest_user)) {?>
